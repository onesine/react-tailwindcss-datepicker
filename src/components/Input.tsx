...
import { BORDER_COLOR, DATE_FORMAT, LABEL_COLOR, RING_COLOR } from "../constants";
...
const Input: React.FC<Props> = (e: Props) => {
    ...
    const getLabelClasses = useCallback(() => {
        ...
        return `absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-4 scale-75 top-2 origin-[0] bg-white dark:bg-gray-900 px-2 peer-focus:px-2 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-1 ${labelColor}`;
    }, [primaryColor]);
