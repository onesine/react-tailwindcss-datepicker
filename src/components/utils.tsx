...
export const RoundedButton: React.FC<Button> = ({children, onClick, roundedFull = false, padding = "py-[0.55rem]"}) => {
    // Contexts
    const {primaryColor} = useContext(DatepickerContext);
...
export const VerticalDash = () => {
    ...
    return (
        <div className={`bg-blue-500 h-7 w-1 rounded-full hidden md:block ${bgColor}`}/>
    );
};