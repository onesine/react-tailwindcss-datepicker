...
export const BORDER_COLOR: Colors = {
    500: {
        blue: "border-[var(--color-blue-500)]",
        orange: "border-[var(--color-orange-500)]",
        yellow: "border-[var(--color-yellow-500)]",
        red: "border-[var(--color-red-500)]",
        purple: "border-[var(--color-purple-500)]",
        amber: "border-[var(--color-amber-500)]",
        lime: "border-[var(--color-lime-500)]",
        green: "border-[var(--color-green-500)]",
        emerald: "border-[var(--color-emerald-500)]",
        teal: "border-[var(--color-teal-500)]",
        cyan: "border-[var(--color-cyan-500)]",
        sky: "border-[var(--color-sky-500)]",
        indigo: "border-[var(--color-indigo-500)]",
        violet: "border-[var(--color-violet-500)]",
        fuchsia: "border-[var(--color-fuchsia-500)]",
        pink: "border-[var(--color-pink-500)]",
        rose: "border-[var(--color-rose-500)]"
    },
    focus: {
        blue: "focus:border-[var(--color-blue-500)]",
        orange: "focus:border-[var(--color-orange-500)]",
        yellow: "focus:border-[var(--color-yellow-500)]",
        red: "focus:border-[var(--color-red-500)]",
        purple: "focus:border-[var(--color-purple-500)]",
        amber: "focus:border-[var(--color-amber-500)]",
        lime: "focus:border-[var(--color-lime-500)]",
        green: "focus:border-[var(--color-green-500)]",
        emerald: "focus:border-[var(--color-emerald-500)]",
        teal: "focus:border-[var(--color-teal-500)]",
        cyan: "focus:border-[var(--color-cyan-500)]",
        sky: "focus:border-[var(--color-sky-500)]",
        indigo: "focus:border-[var(--color-indigo-500)]",
        violet: "focus:border-[var(--color-violet-500)]",
        fuchsia: "focus:border-[var(--color-fuchsia-500)]",
        pink: "focus:border-[var(--color-pink-500)]",
        rose: "focus:border-[var(--color-rose-500)]"
    }
};
