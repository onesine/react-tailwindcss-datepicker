...
const Days = ({ calendarData, onClickPreviousDays, onClickDay, onClickNextDays }) => {
    // Contexts
    const { primaryColor, period, changePeriod, dayHover, changeDayHover, minDate, maxDate, disabledDates, isStaticPosition } = React.useContext(DatepickerContext);
    // Functions
    ...
    return (React__default["default"].createElement("div", { className: `grid grid-cols-7 ${calendarGridClasses} my-1` },
...
const Calendar = ({ changeMonth, changeYear, date, maxDate, minDate, onClickNext, onClickPrevious }) => {
    // Contexts
    const { asSingle, changeDatepickerValue, changeDayHover, changePeriod, disableAutoHide, hideDatepicker, i18n, input, isStaticPosition, period, showFooter, startWeekOn } = React.useContext(DatepickerContext);
    loadLanguageModule(i18n);
    // States
    ...
    return (React__default["default"].createElement("div", { className: `w-full md:w-[296px] md:min-w-[296px] ${additionalClasses}` },
...
const Input = (e) => {
    // Context
    const { primaryColor, period, dayHover, changeDayHover, calendarContainer, arrowContainer, inputText, changeInputText, hideDatepicker, showDatePicker, changeDatepickerValue, asSingle, placeholder, separator, disabled, inputClassName, toggleClassName, toggleIcon, readOnly, displayFormat, inputId, inputName, classNames, popoverDirection, isStaticPosition } = React.useContext(DatepickerContext);
    // UseRefs
    ...
    return (React__default["default"].createElement(React__default["default"].Fragment, null,
        React__default["default"].createElement("input", { ref: inputRef, type: isStaticPosition ? "hidden" : "text", className: getClassName(), disabled: disabled, readOnly: readOnly, placeholder: placeholder
                ? placeholder
...
const ItemTemplate = React__default["default"].memo((props) => {
    const { changeDatepickerValue, changeDayHover, changePeriod, dayHover, hideDatepicker, period, primaryColor, updateFirstDate } = React.useContext(DatepickerContext);
    // Functions
    const getClassName = React.useCallback(() => {
...
const Datepicker = ({ asSingle: defaultAsSingle = false, classNames = undefined, configs = undefined, containerClassName = null, dateLooking = "forward", disableAutoHide = false, disabled = false, disabledDates = null, displayFormat = DATE_FORMAT, i18n = LANGUAGE, inputClassName = null, inputId, inputName, isStaticPosition = false, maxDate = null, minDate = null, onChange, placeholder = null, popoverDirection = undefined, primaryColor = "blue", readOnly = false, renderFooter, renderHeader, separator = "~", showFooter = false, showShortcuts = false, startFrom = null, startWeekOn = "sun", toggleClassName = null, toggleIcon = undefined, useRange: defaultUseRange = true, value = null }) => {
    ...
    const [asSingle, setAsSingle] = React.useState(defaultAsSingle);
    const [useRange, setUseRange] = React.useState(defaultUseRange);
    const toggleSingleView = React.useCallback((enableSingleMode) => {
    ...
    return (React__default["default"].createElement(DatepickerContext.Provider, { value: contextValues },
        React__default["default"].createElement("div", { className: containerClassNameOverload, ref: containerRef },
            ...
            React__default["default"].createElement("div", { className: `transition-all ease-out duration-300 z-10 mt-[1px] text-sm lg:text-xs 2xl:text-sm translate-y-4 opacity-0 hidden ${!isStaticPosition ? "absolute" : "flex"}`, ref: calendarContainerRef },
                !!0 ,
                React__default["default"].createElement("div", { className: `mt-2.5 py-0.5 bg-white dark:bg-slate-800 dark:text-white dark:border-slate-600 rounded-lg ${calendarBorders}` },
