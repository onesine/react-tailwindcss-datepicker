...
export default function Playground() {
    ...
    return (
        <div className="px-4 py-8">
            <Head>
                <title>tailwindcss-react-datepicker PlayGround</title>
            </Head>
                ...
                <Datepicker
                    ...
                    renderHeader={
                        showExtraHeader
                            ? c => {
                                  return (
                                      <label class="relative inline-flex items-center m-5 cursor-pointer">
                                          <input
                                              type="checkbox"
                                              value={c.asSingle}
                                              onChange={e => {
                                                  c.toggleSingleView(e.target.checked);
                                              }}
                                              class="sr-only peer"
                                          ></input>
            ...
            <div className="flex flex-row flex-wrap items-center justify-center w-full">
                <a
                    href="https://github.com/vasinkevych/tailwindcss-react-datepicker"
